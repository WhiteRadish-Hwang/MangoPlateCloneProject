...
class HolicFragment : BaseFragment<FragmentNewsHolicBinding>(FragmentNewsHolicBinding::bind, R.layout.fragment_news_holic){
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.holicLayoutExpanable.setOnClickListener {
            HollicRecyclerAdapter.isExpandable = !HollicRecyclerAdapter.isExpandable
            binding.holicLayoutExplain.visibility = if (HollicRecyclerAdapter.isExpandable) View.VISIBLE else View.GONE
        }
    }
...
//        val item = TotalRecyclerItems(innerImageItems = null, reviewCount = null, likeCount = null,
//            followerCount = null, commentCount = null,
//            restaurantInfo = "",dateTimeAgo = "", expendable = false,
